...
### Duplicacao de metadados de regras

A duplicacao de JSONs de regras entre `ollantarules` e `ollantaweb/api/rules_data` e uma divida conhecida por causa da fronteira CGO. Nao chamaria isso de over-engineering gratuito; e uma solucao pragmatica para manter `ollantaweb` sem CGO. Mas o custo e real: drift silencioso. O melhor destino e extrair metadados para um modulo/shared package sem CGO.
