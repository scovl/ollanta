...
import { configureSurvivedMutantsFeature } from './features/survived-mutants.js';
import { configureTagsFeature } from './features/tags.js';
import { configureProjectFlowFeature, switchTab } from './project-flow.js';
...
configureSurvivedMutantsFeature({ render, switchTab });
...
export { loadSurvivedMutants, renderSurvivedMutantsTab } from './features/survived-mutants.js';
export { changeScope, loadProject, renderScopeToolbar, switchTab } from './project-flow.js';
export { bootBrowserApp, init, loadProjects, render, renderApiDocsPage } from './shell.js';
